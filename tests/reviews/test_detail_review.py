...
class ReviewDetailView(APITestCase):
    ...
    def setUpTestData(cls) -> None:
       # Create User_example
        ...
        cls.review_1 = create_review(user=cls.user_1_super, review_data=cls.review_data_1)
        cls.review_data_2 = {
            "review_text": "Example review text",
            "stars": 2,
        ...
        cls.review_2 = create_review(user=cls.user_1_super, review_data=cls.review_data_2)
    ...
    def test_update_review_with_token(self):
        ...
        response = self.client.patch(self.BASE_URL_review_2, data=review_update, format="json")
        ...
        expected_data = {
            ...
            "reservation": {
                ...
                "created_at": self.review_2.reservation.created_at.strftime('%Y-%m-%dT%H:%M:%S.%fZ'),
                "updated_at": self.review_2.reservation.updated_at.strftime('%Y-%m-%dT%H:%M:%S.%fZ')
            }
        }
        resulted_data = response.json()
        msg = (
